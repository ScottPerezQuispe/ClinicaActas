...
public class FrmUsuario extends javax.swing.JPanel {
    ...
    String[] columnNames = {"ID", "Nombres", "Apellidos", "DNI", "Área"};
    
    // 2. Crear un DefaultTableModel personalizado (Anonymous Class)
    //    y sobrescribir isCellEditable para devolver siempre 'false'.
    ...
    // 3. Asignar el modelo personalizado a la JTable
    tb_Usuario.setModel(modelo);
        
        String Apellido=txt_Buscar.getText();
        List<Empleado> lista = empleadoRepository.Listar(Apellido); // método que devuelve todos los Empleados
    ...
    private void initComponents() {
        ...
        tb_Usuario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nombres", "Apellidos", "DNI", "Area"
            }
        ) {
